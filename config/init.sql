...
INSERT INTO
    users (username, password, role, balance)
VALUES
    (
        'admin',
        '$2y$10$S7x1hbrL4bavEMz2B7O4ceRIixBHHH7SliQ/VmQaIzlmYMu0LU3La',
        'admin',
        0
    ),
    (
        'budi',
        '$2y$10$MHBBH5ioHp77Sp0CldFsruKXlLDqN04Xjtp5q/1Se43T5Shkpfoay',
        'consumen',
        2500000
    ),
    (
        'RajaKentang',
        '$2y$10$/J3YcnlQl2EnvA08jtL2o.1/svrPMDFjVgOqnRUvkbQ0ek/NVzR3a',
        'pelapak',
        0
    ),
    (
        'juna',
        '$2y$10$juKShCgEaSTiVhCMskzSh.dyDnBZFmZTcrivHdgZh3X1mobF1LnM6',
        'operator',
        0
    );
